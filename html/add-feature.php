...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Add New Feature - Sapphire Finishing Mills Ltd.</title>
    ...
    <div class="container-narrow">
      ...
      <hr>
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="features.php">Fabric Features</a> <span class="divider">/</span></li>
          <li class="active">Add New Febric Features</li>
        </ul><br />
      ...
      <form class="form-horizontal">
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" id="inputFeature" placeholder="Feature" class="input-xxlarge">
          </div>
        </div>
