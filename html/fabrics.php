...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Fabrics - Sapphire Finishing Mills Ltd.</title>
  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <hr>
        ...
        <h2 class="muted">Fabrics</h2>
        
        <ul class="breadcrumb">
          <li><a href="dashboard.php">Dashboard</a> <span class="divider">/</span></li>
          <li class="active">Febrics</li>
        </ul><br />
        
      <a class="btn btn-large btn-success" href="add-fabrics.php" style="display:block; width:150px; margin:0px auto;">Add New Fabrics</a>
