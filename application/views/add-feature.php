{page_header}
      ...
      <h2 class="muted">Add New Fabrics Feature</h2>
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">Add New Febrics Feature</li>
      </ul><br />
      ...
      <div class="row-fluid marketing controls-row">
        ...
        <form class="form-horizontal" method="post" id="frmFeature" action="">
          ...
          <div class="control-group" id="featureDiv">
            ...
            <div class="controls">
              <input type="text" id="inputFeature" name="inputFeature" placeholder="Feature" class="input-xxlarge" value="" >
          ...
          <div class="control-group">
            <div class="controls">
              ...
              <button type="submit" class="btn btn-primary">Add New Feature</button> <a href="{base_url}features" class="btn">Back</a>
            </div>
          </div>
        </form>
